    ...
    executeWorkflow: async function (opts) {
        ...
        try {
            var result = await runtime.flows.setFlows(
                opts.flows.flows,        // the array directly
                opts.flows.credentials,  // credentials
            ...
            return {
                ...
                "HITL": true,
                "conversation": [
                    { "agent": "Researcher", "message": "Here is what I found..." },
                    { "agent": "Writer", "message": "Based on the research..." }
                ]
