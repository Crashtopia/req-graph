...
RED.sidebar = (function () {
    ...
    function init() {
        ...
        RED.events.on("editor:open", function () {
            ...
            setTimeout(function () {
                ...
                if (RED.sidebar.models.getKey("gemini")) {
                    select.append($("<option>").val("gemini").text("Gemini"));
                }
                if (RED.sidebar.models.getKey("mistral")) {
                    select.append($("<option>").val("mistral").text("Mistral"));
                }
        ...
        RED.events.on("nodes:add", function (node) {
            if (node.type !== "Product Owner") return;
            if (node.model) return;

            var geminiKey = RED.sidebar.models.getKey("gemini");
            var mistralKey = RED.sidebar.models.getKey("mistral");

            if (geminiKey) {
                node.model = "gemini-2.5-flash";
            } else if (mistralKey) {
                node.model = "mistral-large-latest";
            }
...
RED.sidebar.models = (function () {
    ...
    function createModelSection(modelName, modelKey) {
        ...
        // Restore saved key and update warning
