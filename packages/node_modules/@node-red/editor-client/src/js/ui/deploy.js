        ...
        $.ajax({
            ...
            function openDialog() {
                ...
                if (data.HITL === true) {
                    ...
                    var sendBtn = $('<button>').text('Send').addClass('red-ui-button');
                    sendBtn.on('click', function () {
                        var value = textInput.val().trim();
                        if (!value) return;
                    });
                    // pressing enter sends text
                ...
                dialog.dialog({
                    ...
                    open: function () {
                        ...
                        btnGroup.append(makeBtn('fa-download', 'Export conversation as JSON', function () {
                            var json = JSON.stringify(data.conversation, null, 2);
                        ...
                        btnGroup.append(makeBtn('fa-file-text-o', 'Export conversation as Markdown', function () {
                            var md = data.conversation.map(function (e) {
                                return '## ' + e.agent + '\n\n' + e.message;
                            }).join('\n\n---\n\n');
                        ...
                        btnGroup.append(makeBtn('fa-flask', 'Export experiment data', function () {
                            var json = JSON.stringify(data.log, null, 2);
