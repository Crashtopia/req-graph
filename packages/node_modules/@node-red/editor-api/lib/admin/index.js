...
module.exports = {
    init: function(settings,runtimeAPI) {
        ...
        // reqGraph
        adminApp.post("/executeWorkflow",needsPermission("flows.write"),flows.executeWorkflow,apiUtil.errorHandler);  // <-- add this
        adminApp.post("/resumeWorkflow", needsPermission("flows.write"), flows.resumeWorkflow, apiUtil.errorHandler);
